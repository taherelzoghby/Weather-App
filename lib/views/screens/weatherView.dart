                        ...
                        minTile(
                          ...
                          column: Column(
                            ...
                            children: [
                              rowInfo(
                                label: 'windspeed',
                                value: '${watchData.weather[0]!.windspeed}',
                              ),
                              rowInfo(
                                label: 'winddir',
                                value: '${watchData.weather[0]!.winddir}',
                              ),
                            ],
                          ),
                        ),
                        minTile(
                          ...
                          column: Column(
                            ...
                            children: [
                              rowInfo(
                                label: 'Sunrise',
                                value: watchData.weather[0]!.sunrise,
                              ),
                              rowInfo(
                                label: 'Sunset',
                    ...
                    child: maxTile(
                      ...
                      column: Column(
                        ...
                        children: [
                          rowInfo(
                            label: 'Humidity',
                            value: '${watchData.weather[0]!.humidity}',
                          ),
                          rowInfo(
                            label: 'Real feel',
                            value: '${watchData.weather[0]!.feelslike}',
                          ),
                          rowInfo(
                            label: 'UV',
                            value: '${watchData.weather[0]!.uvindex}',
                          ),
                          rowInfo(
                            label: 'pressure',
                            value: '${watchData.weather[0]!.pressure}',
                          ),
                          rowInfo(
                            label: 'visibility',
                            value: '${watchData.weather[0]!.visibility}',
                          ),
                        ],
                      ),
                    ),
